    ...
    >
      {!mobile && (
        <Button
          ...
          className="h-8 w-8 rounded-full p-0 z-[500] absolute left-full rtl:right-full rtl:left-0 -translate-x-1/2 rtl:translate-x-1/2 -translate-y-1/2 top-16 bg-slate-50 dark:bg-dark-card border-2 "
        >
          <Icon
