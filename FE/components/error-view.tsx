  ...
  return (
    <div className="flex items-center justify-center relative flex-col">
      ...
      <div className="relative ">
        ...
        /> */}
        <div className="w-[50rem] min-h-36 backdrop-blur-sm rounded-md bg-black/5 dark:bg-black/15  flex items-center justify-center px-8 py-10 shadow-md flex-col gap-8 ">
