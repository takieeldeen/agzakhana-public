...
export default function ListView() {
  ...
  // Data Fetching Hooks ////////////////////////////////////
  const { data, isLoading, isFetching, results } = useGetBranches(
    +filtervalues.size,
    page,
    filters,
      ...
      <>
        <EmptyView
          ...
          title={t("COMMON.EMPTY_TITLE", {
            ENTITY_NAME: t("BRANCHES_MANAGEMENT.ENTITY_PLURAL"),
          })}
      ...
      <div className="flex md:flex-row flex-col md:gap-0 gap-2  justify-between md:sticky relative md:top-0 bg-slate-50 pt-2 z-20 dark:bg-dark-background">
        <div className="flex flex-col">
          <h3 className="text-3xl font-bold dark:text-white">
            {t("BRANCHES_MANAGEMENT.LIST_TITLE")}
          </h3>
          <div className="flex flex-row gap-4">
            <p className="dark:text-gray-200">
              {t("BRANCHES_MANAGEMENT.LIST_SUBTITLE")}
            </p>
            <AnimatePresence>
              {isFetching && (
                <motion.div
        ...
        <div className="flex flex-row gap-2">
          ...
          >
            ...
            {t("COMMON.ADD_ENTITY", {
              ENTITY_NAME: t("BRANCHES_MANAGEMENT.INDIFINITE_ENTITY_NAME"),
            })}
          </Button>
        </div>
      </div>
