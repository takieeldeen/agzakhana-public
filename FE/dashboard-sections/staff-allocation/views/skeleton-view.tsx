    ...
    <div className="flex flex-col gap-3 h-full px-2 py-2">
      ...
      <div className="flex flex-row gap-3 relative items-stretch h-full">
        ...
        <div className=" w-full h-full relative">
          <div className="absolute h-full w-full  overflow-x-auto flex flex-row gap-3 py-2">
            <Skeleton className="w-96 h-full flex-shrink-0" />
            <Skeleton className="w-96 h-full flex-shrink-0" />
            <Skeleton className="w-96 h-full flex-shrink-0" />
            <Skeleton className="w-96 h-full flex-shrink-0" />
            <Skeleton className="w-96 h-full flex-shrink-0" />
...
export function DetailsSkeletonView() {
  return (
    <div className="h-full dark:bg-dark-card flex flex-col">
      {/* Details Header */}
      <div className="bg-emerald-600 h-fit md:h-1/8 md:min-h-48 p-6 flex flex-col items-center md:items-start md:flex-row gap-3">
        <Skeleton className="h-48 w-48 md:h-full md:w-fit aspect-square rounded-full bg-emerald-800" />
        ...
        <div className="flex flex-col w-full md:w-fit md:flex-row items-start gap-3 ">
          <Skeleton className="w-full md:w-36 h-12 rounded-xl bg-emerald-800" />
          <Skeleton className="w-full md:w-36 h-12 rounded-xl bg-emerald-800" />
        </div>
      </div>
      {/* Details Content */}
      <div className="relative flex-1 width-full">
        <div className="h-full relative md:absolute overflow-y-auto w-full ">
          <div className="p-3 flex flex-col gap-6 dark:bg-dark-card w-full ">
            <div className="flex flex-col md:flex-row gap-6 md:gap-3 w-full ">
                ...
                {[1, 2, 3, 4]?.map((user) => (
                  ...
                  >
                    ...
                    <div className="flex flex-row flex-1 justify-between">
                      ...
                      <Skeleton className="md:h-12 md:w-32 w-12 h-12 rounded-full dark:bg-dark-975" />
                    </div>
                  </div>
                ))}
              </div>
...
export function KanbanSkeletonView() {
  return (
